...
if ($role === "student") {
    ...
    $deptSelect = $hasDeptCol ? "u.department_id" : "p.department_id AS department_id";

    $stmt = mysqli_prepare($conn, "
        SELECT u.id, u.name, u.role, u.roll_number, u.password_hash, $deptSelect,
...
$hasDeptCol = function_exists('pbl_has_column') ? pbl_has_column($conn, 'users', 'department_id') : true;
$selectCols = $hasDeptCol
    ? "id, name, role, email, password_hash, department_id"
    : "id, name, role, email, password_hash, NULL AS department_id";
...
$redirects = [
    ...
    "chairman"    => "pages/chairman/dashboard.php"
];
